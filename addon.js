...
const manifest = {
    id: "org.iptvexample.working.from.example",
    version: "1.0.0",
    name: "IPTV Voorbeeld (Werkende Structuur)",
    description: "Een stabiele addon gebaseerd op een bewezen, werkende architectuur.",
